...
var FF3 = (function (window, $, module, undefined) {
  ...
  function randomizeWeaponShops(ROM) {
    ...
    weapons = $.map(weapons, function (a) {
      return $.inArray(a, item_pool) < 0 ? null : a;
    });
  ...
  function randomizeChests(ROM) {
    ROM.set(
      module.random_array_from(item_pool, 512),
      module.address.chestsData
    );
  }

  function randomizeDropsSteals(ROM) {
    ROM.set(
      module.random_array_from(item_pool, 256),
      module.address.dropsStealsData
    );
  }
