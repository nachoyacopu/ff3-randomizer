...
var FF3 = (function (window, $, module, undefined) {
  ...
  module.randomizeROM = function (buffer) {
    ...
    ROM = new window.ByteArray(buffer).injectRandomizerMethods();
    ...
    if ($("#chk-patch-boulderless").is(":checked"))
      module.applyPatch("boulderless", ROM);
    ...
    if ($("#chk-jobs-shuffle").is(":checked")) module.jobs.shuffleJobs(ROM);
    //shuffleJobs();
    ...
    // Boosts
    if ($("#chk-boost-exp").is(":checked")) module.misc.boostExp(ROM);
    if ($("#chk-boost-gold").is(":checked")) module.misc.boostGold(ROM);
    if ($("#chk-boost-cap").is(":checked")) module.misc.boostCapacity(ROM);
    ...
    // Visual
    if ($("#chk-ve-menu").is(":checked")) module.visual.randomizeMenuColor(ROM);
    ...
    // Misc
    if ($("#chk-misc-saveanywhere").is(":checked")) ROM[0x7a5b5] = 0x00;
    ...
    if ($("#chk-misc-fatchocobo").is(":checked")) ROM[0x7b4d2] = 0x0d;
